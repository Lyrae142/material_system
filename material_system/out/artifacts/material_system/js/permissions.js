    ...
    methods:{
        delPermission:function (id) {
            ...
            layer.confirm("确认删除该权限信息？",  {icon: 3, title:'确认'}, function(cindex){
                layer.close(cindex);
                console.log(id);
                axios.get('/manage_sys_web/permissions/delPermission?id='+id)
        ...
        delPermissions:function () {
            ...
            layer.confirm("确认批量删除所选中的记录？",  {icon: 3, title:'确认'}, function(cindex){
                layer.close(cindex);
                axios.post('/manage_sys_web/permissions/delPermissions',_this.ids)
                    .then(function (response) {
                        _this.findAll();
                    })
                    .catch(function (error) {
        ...
        search:function(){
          var _this = this;
          axios.get('/manage_sys_web/permissions/findAllByPermissionName',{
              params:{
        ...
        addPermission:function(){
          var _this = this;
          axios.post('/manage_sys_web/permissions/addPermission',_this.newPermission)
              .then(function (response) {
                _this.findAll();
              })
              .catch(function (error) {
        ...
        findAll:function(){
          var _this = this;
          axios.get('/manage_sys_web/permissions/findAll')
              .then(function (response) {
                _this.permissionList = response.data;
              })
              .catch(function (error) {

    ...
    methods:{
        addRoles:function(){
            ...
            layer.confirm("是否为此用户添加选中角色？",  {icon: 3, title:'确认'}, function(cindex){
                layer.close(cindex);
                axios.post('/manage_sys_web/users/addRoles', _this.newUserInfo)
        ...
        loadRolesById:function(id){
          ...
          $("#roleAll").iCheck("uncheck");
            ...
            axios.get('/manage_sys_web/users/loadRolesById',{
                params:{
                    id:id
                }
            })
        ...
        search:function(){
          var _this = this;
          axios.get('/manage_sys_web/users/findAllByUsername',{
              params:{
        ...
        shutdown:function(id){
            var _this = this;
            axios.get('/manage_sys_web/users/shutdown',{
                params:{
                    id:id
                }
            })
        ...
        authentic:function(id){
          var _this = this;
          axios.get('/manage_sys_web/users/authentic',{
              params:{
                  id:id
              }
          })
        ...
        getDetail:function(id){
          var _this = this;
          axios.get('/manage_sys_web/users/getDetail?id='+id)
              .then(function (response) {
        ...
        addUser:function(){
          var _this = this;
          axios.post('/manage_sys_web/users/addUser',_this.newUserInfo)
              .then(function (response) {
                _this.findAll();
              })
              .catch(function (error) {
        ...
        findAll:function(){
          var _this = this;
          axios.get('/manage_sys_web/users/findAll')
              .then(function (response) {
                  _this.userList = response.data;
              })
              .catch(function (error) {

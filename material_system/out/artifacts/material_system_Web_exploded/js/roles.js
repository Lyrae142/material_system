    ...
    methods:{
        addPermissions:function(){
            ...
            layer.confirm("是否为此用户添加选中权限？",  {icon: 3, title:'确认'}, function(cindex){
                layer.close(cindex);
                axios.post('/manage_sys_web/roles/addPermissions', _this.newRole)
        ...
        loadPermissionsById:function(id){
            ...
            axios.get('/manage_sys_web/roles/loadPermissionsById',{
                params:{
                    id:id
                }
            })
        ...
        search:function(){
          var _this = this;
          axios.get('/manage_sys_web/roles/findAllByRoleName',{
              params:{
        ...
        getDetail:function(id){
          var _this = this;
          axios.get('/manage_sys_web/roles/getDetail?id='+id)
              .then(function (response) {
        ...
        addRole:function(){
          var _this = this;
          axios.post('/manage_sys_web/roles/addRole',_this.newRole)
              .then(function (response) {
                _this.findAll();
              })
              .catch(function (error) {
        ...
        findAll:function(){
          var _this = this;
          axios.get('/manage_sys_web/roles/findAll')
              .then(function (response) {
                    _this.roleList = response.data;
              })
              .catch(function (error) {

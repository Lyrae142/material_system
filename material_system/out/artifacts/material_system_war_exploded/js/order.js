new Vue({
    ...
    methods:{
        findAll:function (page,size) {
            var _this = this;
            axios.get('/material_system/orders/findAll?page='+page+'&size='+size)
        ...
        findById:function (id) {
            var _this = this;
            axios.get('/material_system/orders/findById',{
                params:{
                    id:id
                }
            })
        ...
        saveOrder:function () {
            var _this = this;
            axios.post('/material_system/orders/update', _this.orders)
                .then(function (response) {
        ...
        findMembers:function () {
            var _this = this;
            axios.get('/material_system/members/findAll')
                .then(function (response) {
        ...
        addOrders:function () {
            ...
            axios.post('/material_system/orders/addOrders',_this.newOrders)
                .then(function (response) {
                    _this.findAll(_this.pageInfo.pageNum,_this.pageInfo.pageSize);
                })
                .catch(function (error) {
        ...
        addProduct4Order:function (id) {
            ...
            var _this = this;
            axios.get('/material_system/product/findProductList')
                .then(function (response) {
        ...
        addProductForOrder:function () {
            ...
            //更新
            axios.post('/material_system/orders/addProduct4Orders',_this.newOrders)
                .then(function (response) {
                    _this.findAll(_this.pageInfo.pageNum,_this.pageInfo.pageSize);
                    if(response.data=="0")
            ...
            layer.confirm("确认删除该订单？",  {icon: 3, title:'确认'}, function(cindex){
                ...
                axios.get('/material_system/orders/findById',{
                    ...
                    if(size>0){
                        ...
                        //size=0时可以删除商品
                        axios.get('/material_system/orders/deleteById',{
                                params:{
                                    id:id
                                }
                            }).then(function (response) {
        ...
        deleteProductOfOrders:function(index) {
            var _this = this;
            //封装数据
            ...
            layer.confirm("确认删除此产品？",  {icon: 3, title:'确认'}, function(cindex){
                layer.close(cindex);
                //异步请求
                axios.post('/material_system/orders/deleteProductOfOrders',_this.newOrders)
                    .then(function (response) {
                        _this.findAll(_this.pageInfo.pageNum,_this.pageInfo.pageSize);
                        _this.newOrders.productList.pop();
        ...
        search:function() {
            var _this = this;
            axios.post('/material_system/orders/searchByOrderNum',{

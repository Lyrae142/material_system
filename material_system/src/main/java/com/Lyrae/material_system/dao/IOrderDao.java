...
public interface IOrderDao {
    ...
    @Results({
            ...
            @Result(property = "totalPrice",column = "id",javaType = Integer.class,one = @One(select = "com.Lyrae.material_system.dao.IOrderDao.findOrderPriceById"))
    })
    ...
    @Results({
            ...
            @Result(property = "payType",column = "payType"),
            @Result(property = "totalPrice",column = "id",javaType = Integer.class,one = @One(select = "com.Lyrae.material_system.dao.IOrderDao.findOrderPriceById")),
            @Result(property = "member",column = "memberId",javaType = Member.class,one = @One(select = "com.Lyrae.material_system.dao.IMemberDao.findById")),
            @Result(property = "productList",column = "id",javaType = java.util.List.class,many = @Many(select = "com.Lyrae.material_system.dao.IProductDao.findProductsByOid")),
    })

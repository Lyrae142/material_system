...
new Vue({
    ...
    methods:{
        ...
        loadProducts:function(){
            var _this = this;
            axios.get('/material_system/stocks/findProductList')
        ...
        findAll:function (page,size) {
            var _this = this;
            axios.get('/material_system/product/findAll?page='+page+'&size='+size)
                .then(function (response) {
                    // handle success
        ...
        findById:function (id) {
            var _this = this;
            axios.get('/material_system/product/findById',{
                    params: {
                        id:id
                    }
                })
        ...
        addProduct:function () {
            ...
            axios.post('/material_system/product/addProduct', _this.newProduct)
                .then(function (response) {
        ...
        update:function () {
            var _this = this;
            axios.post('/material_system/product/update', _this.product)
                .then(function (response) {
                    _this.findAll(_this.pageInfo.pageNum,_this.pageInfo.pageSize);
                })
                .catch(function (error) {
        ...
        deleteById:function (id) {
            ...
            layer.confirm("确认删除该产品？",  {icon: 3, title:'确认'}, function(cindex){
                layer.close(cindex);
                console.log(id);
                axios.post('/material_system/product/deleteById', {id: id})
                    .then(function (response) {
                        _this.findAll(_this.pageInfo.pageNum,_this.pageInfo.pageSize);
                    })
                    .catch(function (error) {
        ...
        deleteProducts:function () {
            ...
            layer.confirm("确认批量删除所选中的产品？",  {icon: 3, title:'确认'}, function(cindex){
                layer.close(cindex);
                axios.post('/material_system/product/deleteProducts',_this.ids)
                    .then(function (response) {
                        _this.findAll(_this.pageInfo.pageNum,_this.pageInfo.pageSize);
                    })
                    .catch(function (error) {
        ...
        search:function() {
            var _this = this;
            axios.post('/material_system/product/searchByProName',{

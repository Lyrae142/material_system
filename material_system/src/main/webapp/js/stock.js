...
new Vue({
    ...
    methods:{
        ...
        addQuant:function(){
            var _this = this;
            axios.post('/material_system/stocks/addQuant', _this.newStock)
        ...
        findAll:function (page,size) {
            var _this = this;
            axios.get('/material_system/stocks/findAll?page='+page+'&size='+size)
                .then(function (response) {
                    // handle success
        ...
        findById:function (id) {
            var _this = this;
            axios.get('/material_system/stocks/findById',{
                    params: {
                        id:id
                    }
                })
        ...
        addStock:function () {
            ...
            axios.post('/material_system/stocks/addStock', _this.newStock)
                .then(function (response) {
                    _this.findAll(_this.pageInfo.pageNum,_this.pageInfo.pageSize);
                    if(response.data=="0")
        ...
        update:function () {
            var _this = this;
            axios.post('/material_system/stocks/update', _this.stock)
                .then(function (response) {
                    _this.findAll(_this.pageInfo.pageNum,_this.pageInfo.pageSize);
                })
                .catch(function (error) {
        ...
        deleteById:function (id) {
            ...
            layer.confirm("确认删除该库存信息？",  {icon: 3, title:'确认'}, function(cindex){
                layer.close(cindex);
                console.log(id);
                axios.post('/material_system/stocks/deleteById', {id: id})
                    .then(function (response) {
                        _this.findAll(_this.pageInfo.pageNum,_this.pageInfo.pageSize);
                    })
                    .catch(function (error) {
        ...
        deleteStocks:function () {
            ...
            layer.confirm("确认批量删除所选中的库存信息？",  {icon: 3, title:'确认'}, function(cindex){
                layer.close(cindex);
                axios.post('/material_system/stocks/deleteStocks',_this.ids)
                    .then(function (response) {
                        _this.findAll(_this.pageInfo.pageNum,_this.pageInfo.pageSize);
                    })
                    .catch(function (error) {
        ...
        search:function() {
            var _this = this;
            axios.post('/material_system/stocks/searchByProName',{
